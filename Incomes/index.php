<?php 
 ...
 $pageArgs["jsScriptList"]= ["../_clientTools/app.js?v10","app_configs.js","app_incomes.js","../_jsWidgets/kChooser.js?v2","../_jsWidgets/kTabNav.js?v2","../_clientTools/postWrap.js"];
...
$customJsScript = ' app.load({title :"'.$pageTitle.'",sourceContext:"Income",urlSet})';
