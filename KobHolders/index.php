  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">   
      ...
      <div class="table-responsive">
        <table id="merhcantList" class="table table-sm">
          <thead>
            <tr>
              <th scope="col">Id # </th>
          ...
          <tbody  v-for="(merchant, index) in merchants" >
              <tr><td>{{merchant.id}}</td><td>{{merchant.name}}</td></tr>
          </tbody>
        </table>
      </div>
    </main>
    ...
    <script>
        app.load({title :"<?php echo $pageTitle ;?>"})
    </script>  
  </body>
</html>
